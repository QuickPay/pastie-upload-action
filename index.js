...
var node_domexception = __nccwpck_require__(236);
// EXTERNAL MODULE: ./node_modules/fetch-blob/file.js
var file = __nccwpck_require__(276);
...
if (!globalThis.DOMException) {
  try {
    const { MessageChannel } = __nccwpck_require__(13),
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require__.e(/* import() */ 629).then(__nccwpck_require__.bind(__nccwpck_require__, 629));
...
var from = __nccwpck_require__(818);
...
const run = async (credentials, doc) => {
